...
class ApproveVisaPage extends StatelessWidget {
  const ApproveVisaPage({
    super.key,
         ...
         ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return VisaRow(
                ...
                fullName: details.travellerDetails[index].fullName ?? "",
          ...
          CustomPagination(
            ...
            onPrevious: () => onPrevious(param.copyWith(page: param.page! - 1)),
